...
```{r feedev, echo=FALSE, fig.cap="Graphic representation of the various peripheral connections possible with the FEED app devopement tool ", out.width = '90%'}
...
```{r feetxt, echo=FALSE, fig.cap="An example of the FEED configuration file that is used to run the VIMS app", out.width = '90%'}
