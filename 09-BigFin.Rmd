...
```{r BFboard1, echo=FALSE, fig.cap="BigFin CEO Chris Bonzek demonstrating the water proof control center of the fish measurement boards", out.width = '90%'}
knitr::include_graphics("images/BigFin/BigFin9.PNG", error = FALSE)
```


```{r BFboard2, echo=FALSE, fig.cap="BigFin CEO Chris Bonzek demonstrating the use of the stylis with the programmed short-cut buttons for species or other category.", out.width = '90%'}
...
```{r BFboard3, echo=FALSE, fig.cap="BigFin CEO Chris Bonzek demonstrating the battery pack on the back of the fish boards which may be changed out if necessary.", out.width = '90%'}
