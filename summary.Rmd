...
NOTE: This Executive Summary was shared with IEP Coordinators Team in Sept of 2023. This report may be downloaded using the below link and Table 1 from this report is included here. 
...
**Top 7 software applications used by IEP for field data entry with pros and cons for each criteria category, listed in order reviewed by the DUWG sub-team. The criteria used for comparison are described here [criteria category](#crittop).**
:::
